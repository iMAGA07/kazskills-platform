...
export const INSTRUCTION_STEPS: InstructionStep[] = [
  ...
  },
  {
    ...
    body: 'Количество попыток не ограничено. Минимальный проходной балл составляет 70% правильных ответов.',
  },
  {
  ...
  },
  {
    ...
    body: 'После достижения проходного балла загрузите имеющееся фото формата «3×4» или сделайте снимок с веб-камеры прямо на платформе — фотография будет добавлена в ваш будущий сертификат.',
  },
];

// Shown under the steps in the instruction modal.
export const INSTRUCTION_FOOTNOTE =
  'После успешного завершения курса оригиналы сертификатов будут направлены вашему руководителю для дальнейшей выдачи.';
